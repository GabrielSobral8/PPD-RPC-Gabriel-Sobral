...
class CalculatorStub(object):
    ...
    def __init__(self, channel):
        ...
        self.Sub = channel.unary_unary(
                '/grpccalc.Calculator/Sub',
                request_serializer=grpcCalc__pb2.Operands.SerializeToString,
                response_deserializer=grpcCalc__pb2.Result.FromString,
                _registered_method=True)
        self.Mul = channel.unary_unary(
                '/grpccalc.Calculator/Mul',
                request_serializer=grpcCalc__pb2.Operands.SerializeToString,
                response_deserializer=grpcCalc__pb2.Result.FromString,
                _registered_method=True)
        self.Div = channel.unary_unary(
                '/grpccalc.Calculator/Div',
                request_serializer=grpcCalc__pb2.Operands.SerializeToString,
                response_deserializer=grpcCalc__pb2.Result.FromString,
                _registered_method=True)
...
def add_CalculatorServicer_to_server(servicer, server):
    ...
    generic_handler = grpc.method_handlers_generic_handler(
            'grpccalc.Calculator', rpc_method_handlers)
    server.add_generic_rpc_handlers((generic_handler,))
    server.add_registered_method_handlers('grpccalc.Calculator', rpc_method_handlers)
