...
class MinerStub(object):
    ...
    def __init__(self, channel):
        ...
        self.getTransactionID = channel.unary_unary(
                ...
                response_deserializer=miner__pb2.IntMsg.FromString,
                _registered_method=True)
        self.getChallenge = channel.unary_unary(
                '/miner.Miner/getChallenge',
                request_serializer=miner__pb2.ChallengeRequest.SerializeToString,
        ...
        self.submitChallenge = channel.unary_unary(
                ...
                request_serializer=miner__pb2.SubmitReq.SerializeToString,
                response_deserializer=miner__pb2.SubmitRes.FromString,
                _registered_method=True)
        ...
        self.getSolution = channel.unary_unary(
                ...
                request_serializer=miner__pb2.ChallengeRequest.SerializeToString,
                response_deserializer=miner__pb2.SolutionStruct.FromString,
                _registered_method=True)
...
def add_MinerServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'getTransactionID': grpc.unary_unary_rpc_method_handler(
                    ...
                    response_serializer=miner__pb2.IntMsg.SerializeToString,
            ),
            'getChallenge': grpc.unary_unary_rpc_method_handler(
                    servicer.getChallenge,
                    request_deserializer=miner__pb2.ChallengeRequest.FromString,
            ...
            'submitChallenge': grpc.unary_unary_rpc_method_handler(
                    ...
                    request_deserializer=miner__pb2.SubmitReq.FromString,
                    response_serializer=miner__pb2.SubmitRes.SerializeToString,
            ),
            ...
            'getSolution': grpc.unary_unary_rpc_method_handler(
                    ...
                    request_deserializer=miner__pb2.ChallengeRequest.FromString,
                    response_serializer=miner__pb2.SolutionStruct.SerializeToString,
            ),
    }
...
class Miner(object):
    ...
    def getChallenge(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/miner.Miner/getChallenge',
            miner__pb2.ChallengeRequest.SerializeToString,
    ...
    def submitChallenge(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/miner.Miner/submitChallenge',
            miner__pb2.SubmitReq.SerializeToString,
            miner__pb2.SubmitRes.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
    ...
    def getSolution(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            '/miner.Miner/getSolution',
            miner__pb2.ChallengeRequest.SerializeToString,
            miner__pb2.SolutionStruct.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
